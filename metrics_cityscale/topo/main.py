...
def worker(tile_idx, args):
    ...
    graph_gt = '../data/cityscale/20cities/region_%s_refine_gt_graph.p'%tile_idx
...
if '__main__' == __name__:
    ...
    idx =  [8, 9, 19, 28, 29, 39, 48, 49, 59, 68, 69, 79, 88, 89, 99, 108, 109, 119, 128, 129, 139, 148, 149, 159, 168, 169, 179]
