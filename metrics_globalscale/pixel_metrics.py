...
def cal_pixelscores(directory, evaluator, name):
    
    gt_path = os.path.join(f'../data/{directory}/road_mask/', f'region_{name}.png')
...
if '__main__' == __name__:
    ...
    _, _, names, names_ood = globalscale_data_partition()
    ...
    for name in tqdm(names):
        cal_pixelscores(directory, evaluator, name)
